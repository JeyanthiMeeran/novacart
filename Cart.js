                    ...
                    <div class="row d-flex justify-content-between">
                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        <div class="col-4 col-lg-3">
                                            <img src={item.products.images[0].images} alt={item.products.name} height="90" width="115" />
                                        </div>

                                        <div class="col-5 col-lg-3">
                                            <Link to={"/products/"+item.products._id} >{item.products.name}</Link>
                                        </div>
                        ...
                        <div class="col-12 col-lg-3 my-4">
                            <div id="order_summary">
                                ...
                                <p>Est. total: <span class="order-summary-values">₹ {Number(cartItems.reduce((acc, item) => (acc + item.products.price * item.qty), 0)).toFixed(2)}</span></p>
